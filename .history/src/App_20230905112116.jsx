    ...
    <section className="movies-layout page-container pb-10">
      ...
      <div className="movies-list  grid grid-cols-4 gap-4">
        <div className="movies-card bg-slate-800 rounded-lg p-3">
          <img src="https://image-us.24h.com.vn/upload/2-2019/images/2019-05-04/1556964571-319-avengers-infinity-war-2-1556858276-width1280height720.jpg" alt="" className="w-full h-[250px] object-cover" />
        </div>
      </div>
    </section>
