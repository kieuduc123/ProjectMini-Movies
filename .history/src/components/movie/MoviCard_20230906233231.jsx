    ...
    return (
        <div className="movies-card flex flex-col bg-slate-800 text-white rounded-lg p-3 h-full select-none">
           ...
           <div className="flex flex-col flex-1">
             ...
             <Button bgColor='secodary'>Watch Now</Button>
               {/* <button onClick={() => nagigate(`/movie/${id}`)} className=" mt-3 py-3 px-6 rounded-lg capitalize bg-primary w-full mt-auto">Watch now</button> */}
            </div>
        </div>
