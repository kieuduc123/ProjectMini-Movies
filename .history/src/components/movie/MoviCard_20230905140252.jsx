...
const MoviCard = ({item}) => {
    ...
    = item;
    return (
        <div className="movies-card flex flex-col bg-slate-800 text-white rounded-lg p-3 h-full">
...
<div className="flex flex-col flex-1">
  ...
  <div className="flex items-center justify-between text-sm opacity-50">
    ...
    <button className=" mt-3 py-3 px-6 rounded-lg capitalize bg-primary w-full mt-auto">Watch now</button>
</div>
</div>
